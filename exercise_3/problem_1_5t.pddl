(define (problem problem3_1)
  ...
  (:htn
    :parameters ()
    :subtasks (and
      (task0 (deliver_valve workstation2))
      (task1 (deliver_valve workstation3))
      (task2 (deliver_bolt workstation1))
      (task3 (deliver_bolt workstation2))
